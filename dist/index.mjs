...
var AsyncMotionValueAnimation = class extends WithPromise {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe, options, sync) {
    ...
    let animation;
    if (useWaapi) {
      options.element = (_b = (_a2 = options.motionValue) == null ? void 0 : _a2.owner) == null ? void 0 : _b.current;
      try {
...
var MotionValue = class {
  ...
  on(eventName, callback) {
    ...
    return ((_a2 = this.events)[eventName] || (_a2[eventName] = new SubscriptionManager())).add(callback);
  }
  onChangeSubscribe(callback) {
    ...
    return () => {
      ...
      if (this.changeSubscriber === callback) {
        ...
        (_a2 = events.change) == null ? void 0 : _a2.remove(callback);
      }
  ...
  stopIfUnobserved() {
    frame.read(() => {
      var _a2;
      if (!this.changeSubscriber && !((_a2 = this.events.change) == null ? void 0 : _a2.getSize())) {
        this.stop();
      }
    });
  }
  ...
  notifyChange() {
    ...
    if (changeSubscriber) {
      ...
      (_a2 = this.events.change) == null ? void 0 : _a2.notify(current);
    }
  }
  ...
  start(startAnimation) {
    ...
    return new Promise((resolve) => {
      ...
      animation = startAnimation(() => {
        var _a3;
        isComplete = true;
        (_a3 = this.events.animationComplete) == null ? void 0 : _a3.notify();
      ...
      (_a2 = this.events.animationStart) == null ? void 0 : _a2.notify();
    });
  }
  /**
...
var DOMKeyframesResolver = class extends KeyframeResolver {
  ...
  measureInitialState() {
    ...
    if (measureKeyframe !== void 0) {
      (_a2 = this.motionValue) == null ? void 0 : _a2.jump(measureKeyframe, false);
    }
  }
  measureEndState() {
    var _a2, _b;
    ...
    if (!element || !element.current)
      return;
    (_a2 = this.motionValue) == null ? void 0 : _a2.jump(this.measuredOrigin, false);
